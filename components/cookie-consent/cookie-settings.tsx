...
import { defaultCategories, useCookieConsent } from "./cookie-provider";
...
export function CookieSettings({ className }: CookieSettingsProps) {
  ...
  return (
    ...
    >
      <DialogContent
        className={cn("sm:max-w-[calc(100%-2rem)] md:max-w-2xl", className)}
      >
        <DialogHeader>
          <div className="flex items-start text-start gap-3">
            ...
            <div>
              <DialogTitle>Twoje preferencje prywatności</DialogTitle>
              <DialogDescription>
                Zarządzaj swoimi preferencjami prywatności poniżej.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
