                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-sm font-semibold text-foreground">
                      Twoje preferencje prywatności
                    </h3>
                    <p className="text-sm text-muted-foreground leading-relaxed max-w-xl">
                      Korzystamy z plików cookies w celu sprawnego działania
                      witryny (cookies niezbędne), personalizacji reklam oraz
                      tworzenia usług i ofert dostosowanych do Twoich potrzeb
                      (cookies opcjonalne – możesz na nie wyrazić zgodę).{" "}
