...
export const defaultCategories: CategoryConfig[] = [
  ...
  },
  {
    ...
    title: "Analityka",
    description:
      "Oprócz zastosowań w analizach biznesowych, analityczne pliki cookies pozwalają nam zrozumieć w jaki sposób korzystasz z naszego sklepu internetowego, wskazać strony wymagające poprawy lub te, które spełniają swoją funkcję i cieszą się dużą popularnością. Co istotne, zebrane informacje są anonimowe i na ich podstawie nie jesteśmy w stanie zidentyfikować Użytkownika.",
  },
  {
    key: "marketing",
    title: "Reklama",
    description:
      "Wyrażając zgodę na te ciasteczka pozwalasz nam dostosować reklamy do Twoich zainteresowań. Z ich pomocą podmioty współpracujące, takie jak Facebook czy Instagram, będą w stanie odpowiednio dopasować wyświetlane treści tak, aby były dla Ciebie użyteczne i odpowiednie. https://business.safety.google/privacy/",
  },
  {
    key: "preferences",
    title: "Personalizacja",
    description:
      "Analizując Twoje zachowanie na stronie oraz preferencje zakupowe dotyczące marek, jesteśmy w stanie wyświetlać spersonalizowane podpowiedzi produktów, dokonywać zmian w obrębie funkcjonalności strony oraz zamieszczać sponsorowane treści. Twoje dane mogą być wykorzystywane do ulepszania istniejących systemów i oprogramowania oraz opracowania nowych rozwiązań.",
  },
];
