...
function DirectionAwareTabs({
  ...
  return (
    <div className="flex flex-col items-center w-full">
      <div
        className={cn(
          "flex divide-x cursor-pointer bg-background border-b border-border w-full shadow-inner-shadow font-secondary",
          className
        )}
      >
        {tabs.map((tab) => (
          ...
          >
            {activeTab === tab.id && (
              <motion.span
                layoutId="bubble"
                className="absolute inset-0 z-10 mix-blend-difference shadow-inner-shadow bg-primary"
