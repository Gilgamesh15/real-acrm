...
type Coupon = DBQueryResult<"coupons", {}>;

const dtf = createColumnConfigHelper<Coupon>();
...
export const columns: ColumnDef<Coupon>[] = [
  ...
  },
  {
    ...
    cell: function Render({ row, table }) {
      ...
      const { deleteCoupon, isDeleting } = table.options
        .meta as CouponDataTableMeta;
      ...
      return (
        ...
        >
          ...
          <DeleteActionDialogContent
            action="delete"
            title="Usuń kupon"
            description={`Czy na pewno chcesz usunąć kupon "${row.original.name}"? Ta akcja jest nieodwracalna.`}
            deleteKeyword="USUŃ"
            deleteLabel="Usuń kupon"
            confirmText="Usuń"
            cancelText="Anuluj"
            onConfirm={() => deleteCoupon(row.original.id)}
          />
        </ActionDialog>
      );
    },
...
export type CouponDataTableMeta = {
